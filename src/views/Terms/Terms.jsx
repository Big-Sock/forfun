...
export const Terms = () => {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to StockSwap Inc.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to StockSwap, accessible from {" "}
            <a
              href="https://www.stockswap.app/"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://www.stockswap.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          By emailing us at stockswapinc@gmail.com
        </li>
      </ul>
    </>
  );
